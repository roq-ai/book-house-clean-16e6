...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`Book House Cleaning Online`}</title>

        <meta
          name="description"
          content="Welcome to Book House Cleaning Online - Where your home's cleanliness and shine is our priority, experience our professional full Home Deep Cleaning Services today."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            <Heading mb={{ base: '12px', lg: '20px' }} size="2xl">
              {`Book House Cleaning Online`}
            </Heading>
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Book House Cleaning Online - Where your home's cleanliness and shine is our priority, experience our professional full Home Deep Cleaning Services today.`}
            </Text>
            <Box
